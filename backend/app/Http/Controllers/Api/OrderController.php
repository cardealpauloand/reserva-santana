...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'shipping_address.number' => ['required', 'string', 'max:20', 'regex:/.*\d.*/'],
            'shipping_address.complement' => 'nullable|string|max:255',
            'shipping_address.neighborhood' => 'required|string|max:255',
            'shipping_address.city' => 'required|string|max:255',
            'shipping_address.state' => ['required', 'string', 'size:2', 'regex:/^[A-Za-z]{2}$/'],
